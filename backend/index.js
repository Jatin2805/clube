...
// import BasicSlider from '../frontend/src/components/BasicSlider/BasicSlider';
...
app.post('/event', (req, res)=>{
    ...
    const {eventname, eventdesc, eventdate, eventtype} = req.body;
    ...
    .then(user => {
        if(user){
            ...
            if(user.email === email) {
                ...
                res.json("No club name found for the email provided");
            }
        }
        // If user not found then 
        else{
